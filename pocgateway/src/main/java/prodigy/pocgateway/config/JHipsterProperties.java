...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "pocgateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "pocgateway API";

        private String description = "pocgateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "pocgateway";
